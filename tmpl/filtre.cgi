...
<P>Pour toute r&eacute;clamation, adressez un message &agrave;
       <A HREF="mailto:cachemaster\@%%nom_academie.%%suffixe_domaine_academique?subject=[plainte%20squidguard]%20$url">cachemaster\@%%nom_domaine_academique</A> en pr&eacute;cisant l'url :
